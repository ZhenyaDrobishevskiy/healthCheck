...
use healthCheck\tests\healthCheck\fakeHealthTests\DemoHealthTest;
...
class HealthCheckTest extends TestCase
{
    ...
    {
        $healthCheck = new HealthCheck();
        $healthTest1 = new DemoHealthTest('Demo Test 1', 'Demo 1');
        $healthTest2 = new DemoHealthTest('Demo Test 2', 'Demo 2');
        $healthTest3 = new DemoHealthTest(['test info' => 'some info', 'details' => 'some details'], 'Demo 3');
    ...
    public function testSelectTestByName()
    {
        ...
        $healthTest1 = new DemoHealthTest('Demo Test 1', 'Demo 1');
        $healthTest2 = new DemoHealthTest('Demo Test 2', 'Demo 2');
        $healthTest3 = new DemoHealthTest('Demo Test 3', 'Demo 3');
        $healthCheck->addTest($healthTest1);
        $healthCheck->addTest($healthTest2);
        $healthCheck->addTest($healthTest3);
